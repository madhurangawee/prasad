...
$pto = trim($_POST['pto']);
$dfrom = trim($_POST['dfrom']);
$dto = trim($_POST['dto']);

//echo $pto;

	
$num_rows= $service->view_book_Advance_Result_Count($keyword,$categories_id,$publisher_id,$pfrom,$pto,$dfrom,$dto);
            $pages = new Paginator;
	   ...
	   $resultset3= $service->view_book_Advance_Result($keyword,$categories_id,$publisher_id,$pfrom,$pto,$dfrom,$dto);
	 
	 if($num_rows == 0)
	 {
		 $add->addAdvance_result_toTable($keyword);
		 ?>
