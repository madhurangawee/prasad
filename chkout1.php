...
<input type="text" name="firstname" size = "33" maxlength = "32" id="firstname" value="<?php echo $cusDet['F_NAME'];  ?>" /><span class="alert">*</span><br class="clearBoth" />



<label class="inputLabel" for="lastname">Last Name:</label>

<input type="text" name="lastname" size = "33" maxlength = "32" id="lastname" value="<?php echo $cusDet['L_NAME'];  ?>" /><span class="alert">*</span><br class="clearBoth" />



<label class="inputLabel" for="street-address">Street Address:</label>

  <input type="text" name="street_address" size = "41" maxlength= "64" id="street_address" value="<?php echo $cusDet['CUS_STREET'];  ?>" /><span class="alert">*</span><br class="clearBoth" />



<label class="inputLabel" for="city">City:</label>

<input type="text" name="city" size = "33" maxlength = "32" id="city" value="<?php echo $cusDet['CUS_CITY'];  ?>" /><span class="alert">*</span><br class="clearBoth" />
...
<input type="text" name="state"  size = "33" maxlength = "32" id="province" value="<?php echo $cusDet['CUS_PROVINCE']; ?>"   />&nbsp;<span class="alert" id="stText">*</span><input type="hidden" name="zone_id" /><br class="clearBoth" />



<label class="inputLabel" for="postcode">Post Code:</label>

<input type="text" name="postcode" size = "11" maxlength = "10" id="postcode" value="<?php echo $cusDet['CUS_POSTCODE'];  ?>" /><span class="alert">*</span><br class="clearBoth" />
...
<input type="radio" name="shipping" value="Free Shipping" id="ship-flat-flat" /><label for="ship-flat-flat" class="checkboxLabel" >Free Shipping With in Sri Lanka</label>
...
<input type="radio" name="shipping" value="Store pickup" id="ship-storepickup-storepickup" checked="checked"   /><label for="ship-storepickup-storepickup" class="checkboxLabel" >Walk In</label>
...
<textarea name="comments" id="description" cols="45" rows="3">none</textarea></fieldset>



<div class="buttonRow forward">

 <input type="image" src="images/buttons/english/button_continue_checkout.gif" alt="Continue" title=" Continue "  onclick="goToChkout2('0');"  /></div>
