...
<script type="text/javascript" src="_js/functions/forgotPassword.js"></script>
...
<div id="passwordForgottenMainContent" class="content">Enter your email address below and we'll send you an email message containing your new password.</div>
...
<div id="msg" ></div>
<div class="buttonRow forward"><input type="image" src="images/buttons/english/button_submit.gif" alt="Submit the Information" title=" Submit the Information " onclick=" return forgotPassword();"></div> 
