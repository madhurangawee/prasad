...
<div id="newProductsDefaultListingTopNumber" class="navSplitPagesResult back">Displaying  <strong>4</strong> (of <strong><?php  echo $num_rows; ?></strong> all products)</div>
...
<?php } ?>
  <div id="newProductsDefaultListingBottomNumber" class="navSplitPagesResult back">Displaying <strong>4</strong> (of <strong><?php  echo $num_rows; ?></strong> all products)</div>
 <div style="float:right;"><?php
      echo $pages->display_pages();
      echo "<span class=\"\">".$pages->display_jump_menu();
