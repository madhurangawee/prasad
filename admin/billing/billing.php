	...
	<div id="content" class="xfluid">
		  ...
		  <div class="portlet x4">
			...
			<form id="addProdType" action="#"  class="form label-top">
					...
					<div class="field">
					  <label for="file_name"> Quantity</label> <input id="SUB_PROD_TYPE" name="SUB_PROD_TYPE" size="30" type="text" value="" />
                    
                     </div>
                     <div class="field">
					  <label for="file_name"> Price</label> <input id="SUB_PROD_TYPE" name="SUB_PROD_TYPE" size="30" type="text" value="" />
	...
	?></div>  
				<table cellpadding="0" cellspacing="0" border="0" class="display" rel="datatable" id="example">
                    ...
                    <?php foreach($resultset as $row){ ?>
						<tr id="catogery<?php echo $row['SUB_CATOGERY_ID']; ?>" >
							<td><?php echo $row['SUB_CATOGERY_ID']; ?></td>
                            <td><?php 
							$resultprod= $result->get_Product_type($row['CATOGERY_ID']);
							echo $resultprod['CATOGERY_NAME']; ?></td>
							<td><span id="features_old<?php echo $row['SUB_CATOGERY_ID']; ?>"><?php echo $row['SUB_CATOGERY_NAME']; ?></span>
                                                <span style="display:none;" id="features_edit<?php echo $row['SUB_CATOGERY_ID']; ?>">
                          <input id="features<?php echo $row['SUB_CATOGERY_ID']; ?>" type="text" value="<?php echo $row['SUB_CATOGERY_NAME']; ?>"/></span></td>
                            
                            <td>
                      
           
     <a style="cursor:pointer;" id="editbtn<?php echo $row['SUB_CATOGERY_ID']; ?>" title="Edit"><img src="../images/edit.png" alt="Edit" onclick="showcatogeryeditdiv(<?php echo $row['SUB_CATOGERY_ID']; ?>)"/></a><a style="display:none;cursor:pointer;" id="savebtn<?php echo $row['SUB_CATOGERY_ID']; ?>"  title="Save"><img src="../images/button_save.png" width="25" alt="Edit" onclick="updatecatogery(<?php echo $row['SUB_CATOGERY_ID']; ?>)"/></a>
     
            <a onclick="deleteFunction('catogery<?php echo $row['SUB_CATOGERY_ID']; ?>','deletecatogery',<?php echo $row['SUB_CATOGERY_ID']; ?>,'Are you sure to delete book Catogery..?')">
