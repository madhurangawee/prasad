		...
		<a href="javascript:;" class="mega-tab">
				...
				<li class="mega">				
					...
					<div class="mega-content mega-menu ">						
						...
						<ul>
							<li><a href="<?php echo HTTP_PATH; ?>supplier/addSupplier.php">Add Supplier</a></li>	
							<li>
                ...
                <li class="mega">				
                    ...
                    <div class="mega-content mega-menu ">						
						...
						<ul>
                            ...
                            <li >				
					                <a href="<?php echo HTTP_PATH; ?>products/viewReviews.php" >View Reviews</a>			
				                    </li>
                            <li >				
					                <a href="<?php echo HTTP_PATH; ?>products/viewReviews.php" >Out Of Stock Products</a>			
				                    </li>
				...
				<li class="mega">
					...
					<div class="mega-content mega-menu ">
                        ...
                        <ul>
                        	...
                        	<li><a href="<?php echo HTTP_PATH; ?>settings/addPublishers.php">Add/View Publishers</a></li>
						</ul>
					</div>						
				</li>
			</ul>
