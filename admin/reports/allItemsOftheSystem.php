...
require_once('../../tcpdf/tcpdf.php');
 ...
 $service = new Service;
 $result1= $service->viewAllBooksOftheSystem();
 $result2= $service->viewAllProductsOftheSystem();
...
$pdf->SetTitle('All Item Of the System');
$pdf->SetSubject('All Item Of the System');
$pdf->SetKeywords('');
...
$html = <<<EOD
<h1>All Items In the System</h1><br/>
