...
require_once('_class/Class.Service.php');
           ...
           $service = new Service;
		   $getCount = $service->getUserCount();
		   $getOrderCount = $service->getTodayOrderCount();
		   $getReviewCount = $service->getTodayReviewCount();
		   $getPReviewCount = $service->getPReviewCount();
		   //$resultz = $service->getmostActiveSearch();
		...
		<div class="portlet x3" style="min-height: 300px;">
			...
			<div class="portlet-content">
				<table cellspacing="0" class="info_table">
					<tbody>
						<tr>
							<td class="value"><?php if($getCount){echo $getCount['COUNT'];}else{ echo '0';}?></td>
							<td class="full">Users Visits</td>
						</tr>
						<tr>
							<td class="value"><?php echo $getOrderCount; ?></td>
							<td class="full">Orders Today</td>
						</tr>
						<tr>
							<td class="value"><?php echo $getReviewCount; ?></td>
							<td class="full">Today Reviews</td>
						</tr>
						<tr>
							<td class="value"><?php echo $getPReviewCount; ?></td>
							<td class="full">Pending Reviews</td>
						</tr>
						<tr>
							<td class="value"><?php //echo $resultz['SEARCH_WORD']; ?></td>
							<td class="full">Famous Not Result Keyword</td>
						</tr>
					</tbody>
				</table>
			</div> <!-- .portlet-content -->			
...
<!-- Mirrored from madebyamp.com/themes/slate/index2.html by HTTrack Website Copier/3.x [XR&CO'2010], Wed, 18 May 2011 05:55:53 GMT -->
</html>