...
class Paginator{
	...
	function display_jump_menu()
	{
		...
		return "<span class=\"paginate\">&nbsp;&nbsp;Page: </span><select class=\"paginate2\" onchange=\"window.location='$_SERVER[PHP_SELF]?page='+this[this.selectedIndex].value+'&ipp=$this->items_per_page$this->querystring';return false\">$option</select>\n";
	}
