...
$pubCat = $service->getPublishers($ID);

$num_rows= $service->view_book_Count_Pub($ID);
            $pages = new Paginator;
...
<script type="text/javascript" src="_js/functions/orderByProducts.js"></script>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" id="contentMainWrapper">
	<tr>
        ...
        <div class="column-center-padding" id="all">
                
    
                    
			<div class="centerColumn" id="newProductsDefault">

<h1 id="newProductsDefaultHeading">Products of <?php echo $pubCat['PUB_NAME']; ?></h1>


<div id="sorter" class="tie2">
<div class="tie2-indent">
	<label for="disp-order-sorter">Sort by: Product Name</label>
...
<br class="clearBoth" />
<?php
 $resultset= $service->view_All_Books_Pub($pages,$ID);
 if(!$resultset) { ?>
	

<h2 id="cartEmptyText">No Products on this publisher.</h2>
<?php 
}else {?>
...
<?php } ?>
  <div id="newProductsDefaultListingBottomNumber" class="navSplitPagesResult back">Displaying <strong>4</strong> (of <strong><?php  echo $num_rows; ?></strong> new products)</div>
 <div style="float:right;"><?php
      echo $pages->display_pages();
      echo "<span class=\"\">".$pages->display_jump_menu();
