...
<script type="text/javascript" src="_js/functions/confirm.js"></script>
...
<label class="inputLabel" for="password-current">Confirmation Code:</label>
<input type="text"  id="confirm_code" value="<?php echo $CODE; ?>"><span class="alert">*</span><br class="clearBoth"><br class="clearBoth">

</fieldset>
<div id="msg" ></div>
 <div class="buttonRow forward"><input type="image" src="images/buttons/english/button_submit.gif" alt="Submit the Information" title=" Submit the Information " onclick=" return confirmAccount();"></div>
				  </div>
